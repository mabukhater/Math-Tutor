...
export const metadata: Metadata = {
  title: "How it works — Astute Academy",
  description: "From sign-up to a daily habit: how Astute Academy places and grows your child.",
};
  ...
  return (
    <MarketingShell>
      <div className="content-wrap">
        <h1>How Astute Academy works</h1>
        <p className="sub">
